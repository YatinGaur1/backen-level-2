...
router.route("/add-v-to-playlist/:playlistId/:videoId").post(addVideoToPlaylist)
router.route("/remove-v-from-playlist/:playlistId/:videoId").post(verifyJwt,removeVideoFromPlaylist)
